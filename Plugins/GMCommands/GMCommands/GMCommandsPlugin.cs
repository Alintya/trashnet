...
namespace GMCommands
{
    ...
    public class GMCommandsPlugin : GamePlugin
    {
        ...
        public GMCommandsPlugin()
        {
            ...
            _commandDescriptions.Add("live", HelperUtils.GetS4Color(255, 0, 0) + "/live <message>");
        ...
        private string live(string[] args, Player sender)
        {
            if (sender.GMLevel < 2)
                return HelperUtils.GetS4Color(255, 0, 0) + "Nope.";

            if (args.Length < 2)
                return _commandDescriptions["live"];

            GameServer.Instance.liveNotice(args[1]);
            return HelperUtils.GetS4Color(0, 255, 0) + "Done.";
        }
